...
import { getUserFromJWT, getUserId } from "../lib/actions";
  ...
  return (
    <nav className="flex bg-primary px-4 2xl:px-96 xl:px-32 lg:px-12 justify-between">
      ...
      <div className="lg:flex hidden items-center text-white">
        <div className="py-6 border-b-2 border-transparent hover:border-white hover:border-b-7">
          <Link href="/writeReview" className="text-white px-4">
            Write Review
          </Link>
        </div>
